...
const radioStyles = { paddingTop: '0em', paddingBottom: '0em' }
    ...
    <IonGrid>
      ...
      <IonRow>
        <IonCol>
          ...
          <IonItem>
            <IonInput label="Deň" labelPlacement="stacked" placeholder="23" size={4}></IonInput>
            <IonInput label="Mesiac" labelPlacement="stacked" placeholder="5" size={4}></IonInput>
            <IonInput label="Rok" labelPlacement="stacked" placeholder="2022" size={8}></IonInput>
          </IonItem>
        </IonCol>
      </IonRow>
      <IonRow>
